...
static unsigned int sqlctx = 2099;
...
{12,4130,1,0,0,
5,0,0,0,0,0,27,26,0,0,4,4,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,30,40,0,0,0,0,0,1,0,
51,0,0,3,0,0,32,42,0,0,0,0,0,1,0,
66,0,0,4,48,0,44,80,0,0,0,0,0,1,0,
81,0,0,5,48,0,3,81,0,0,0,0,0,1,0,
96,0,0,6,0,0,29,82,0,0,0,0,0,1,0,
111,0,0,7,53,0,4,83,0,0,1,0,0,1,0,2,9,0,0,
};
...

{
     ...
     sqlstm.sqladtp = &sqladt;
     sqlstm.sqltdsp = &sqltds;
     sqlstm.stmt = "insert into hello_world  values ('Hello world!')";
     sqlstm.iters = (unsigned int  )1;
...

{
     ...
     sqlstm.sqlety = (unsigned short)4352;
     sqlstm.occurs = (unsigned int  )0;
     sqlstm.sqhstv[0] = (unsigned char  *)&msg_buf;
